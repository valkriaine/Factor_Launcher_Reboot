...
class BouncyNestedScrollView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
        ...
        when (actionMasked) {
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                if (mIsBeingDragged) {
                    ...
                    if (overScrollByCompat(deltaY, 0, scrollY, range, 0, 0, true) && !hasNestedScrollingParent(
    ...
    override fun onRequestFocusInDescendants(direction: Int, previouslyFocusedRect: Rect?): Boolean {
        if (previouslyFocusedRect != null) {
            ...
            val nextFocus =
                FocusFinder.getInstance().findNextFocusFromRect(this, previouslyFocusedRect, mDirection) ?: return false
