...
public class BouncyScrollView extends FrameLayout implements NestedScrollingParent3,
        NestedScrollingChild3, ScrollingView
{
    ...
    private static final String TAG = "BouncyScrollView";
     ...
     *
     * @see #setOnScrollChangeListener(BouncyScrollView.OnScrollChangeListener)
     */
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(BouncyScrollView v, int scrollX, int scrollY,
    ...
    private BouncyScrollView.SavedState mSavedState;

    private static final BouncyScrollView.AccessibilityDelegate ACCESSIBILITY_DELEGATE
            = new BouncyScrollView.AccessibilityDelegate();
    ...
    private BouncyScrollView.OnScrollChangeListener mOnScrollChangeListener;

    private final SpringAnimation spring = new SpringAnimation(this, SpringAnimation.TRANSLATION_Y)
            .setSpring(new SpringForce()
                            .setFinalPosition(0f)
                            .setDampingRatio(SpringForce.DAMPING_RATIO_NO_BOUNCY)
                            .setStiffness(SpringForce.STIFFNESS_LOW));

    public BouncyScrollView(@NonNull Context context) {
        this(context, null);
    }

    public BouncyScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public void dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed,
        ...
        mChildHelper.dispatchNestedScroll(dxConsumed, dyConsumed,
    ...
    private void onNestedScrollInternal(int dyUnconsumed, int type, @Nullable int[] consumed) {
        ...
        mChildHelper.dispatchNestedScroll(0, myConsumed,
    ...
    protected float getBottomFadingEdgeStrength() {
        ...
        final BouncyScrollView.LayoutParams lp = (LayoutParams) child.getLayoutParams();
        final int length = getVerticalFadingEdgeLength();
    ...
    public void setOnScrollChangeListener(@Nullable BouncyScrollView.OnScrollChangeListener l) {
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    if (overScrollByCompat(deltaY, 0, getScrollY(), range, 0,
    ...
    int getScrollRange() {
        ...
        if (getChildCount() > 0) {
            View child = getChildAt(0);
            BouncyScrollView.LayoutParams lp = (LayoutParams) child.getLayoutParams();
            int childSize = child.getHeight() + lp.topMargin + lp.bottomMargin;
            int parentSpace = getHeight() - getPaddingTop() - getPaddingBottom();
    ...
    public boolean pageScroll(int direction) {
        ...
        if (down) {
            ...
            if (count > 0) {
                ...
                BouncyScrollView.LayoutParams lp = (LayoutParams) view.getLayoutParams();
    ...
    public void computeScroll() {
        ...
        if (unconsumed != 0) {
            // Internal Scroll
            final int oldScrollY = getScrollY();
            overScrollByCompat(unconsumed, getScrollX(), oldScrollY, range, 0, 0, false);
    ...
    private void ensureGlows() {
        if (getOverScrollMode() != View.OVER_SCROLL_NEVER) {
            if (mEdgeGlowTop == null) {
                ...
                mEdgeGlowTop = new BouncyEdgeEffect(context, spring, this, DIRECTION_TOP);
                mEdgeGlowBottom = new BouncyEdgeEffect(context, spring, this, DIRECTION_BOTTOM);
            }
        } else {
            mEdgeGlowTop = null;
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof BouncyScrollView.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        BouncyScrollView.SavedState ss = (BouncyScrollView.SavedState) state;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        BouncyScrollView.SavedState ss = new BouncyScrollView.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<BouncyScrollView.SavedState> CREATOR =
                new Parcelable.Creator<BouncyScrollView.SavedState>() {
                    @Override
                    public BouncyScrollView.SavedState createFromParcel(Parcel in) {
                        return new BouncyScrollView.SavedState(in);
                    }

                    @Override
                    public BouncyScrollView.SavedState[] newArray(int size) {
                        return new BouncyScrollView.SavedState[size];
                    }
                };
    }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final BouncyScrollView nsvHost = (BouncyScrollView) host;
