...
public class InvisibleRefreshLayout extends ViewGroup implements NestedScrollingParent3,
     ...
     * @param context
     */
    public InvisibleRefreshLayout(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public InvisibleRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
     ...
     * gesture.
     */
    public void setOnRefreshListener(@Nullable InvisibleRefreshLayout.OnRefreshListener listener) {
        mListener = listener;
    }
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(@NonNull InvisibleRefreshLayout parent, @Nullable View child);
    }
}
